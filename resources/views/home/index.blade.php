...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('<?php echo url('/'); ?>/images/bg_2.jpg');" data-section="home" data-stellar-background-ratio="0.5">
            ...
            <div class="carousel-properties owl-carousel">
            	<div class="item">
            		<div class="properties ftco-animate">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/work-1.jpg" class="img-fluid" alt="Colorlib Template">
			    				</div>
			    				<div class="desc">
            	...
            	<div class="item">
            		<div class="properties ftco-animate">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/work-2.jpg" class="img-fluid" alt="Colorlib Template">
			    				</div>
			    				<div class="desc">
            	...
            	<div class="item">
            		<div class="properties ftco-animate">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/work-3.jpg" class="img-fluid" alt="Colorlib Template">
			    				</div>
			    				<div class="desc">
			    					<div class="text bg-primary d-flex text-center align-items-center justify-content-center">
				    					<span>Sale</span>
            	...
            	<div class="item">
            		<div class="properties ftco-animate">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/work-4.jpg" class="img-fluid" alt="Colorlib Template">
			    				</div>
			    				<div class="desc">
			    					<div class="text bg-primary d-flex text-center align-items-center justify-content-center">
				    					<span>Sale</span>
            	...
            	<div class="item">
            		<div class="properties ftco-animate">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/work-5.jpg" class="img-fluid" alt="Colorlib Template">
			    				</div>
			    				<div class="desc">
			    					<div class="text bg-secondary d-flex text-center align-items-center justify-content-center">
				    					<span>Rent</span>
    ...
    <section class="ftco-intro img" id="about-section" style="background-image: url(<?php echo url('/'); ?>/images/bg_1.jpg);">
			<div class="overlay"></div>
			<div class="container">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<?php echo url('/'); ?>/images/about.jpg);">
    				</div>
    			</div>
    ...
    <section class="ftco-section ftco-services-2 bg-light" id="workflow-section">
		...
		<section class="ftco-intro img" id="hotel-section" style="background-image: url(<?php echo url('/'); ?>/images/bg_4.jpg);">
			<div class="overlay"></div>
			<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-agent owl-carousel">
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/team-1.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/team-2.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/team-3.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
            	...
            	<div class="item">
            		<div class="agent">
		    					<div class="img">
				    				<img src="<?php echo url('/'); ?>/images/team-4.jpg" class="img-fluid" alt="Colorlib Template">
				    				<div>
				    					<h3>I'm an agent</h3>
				    				</div>
			    				</div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_2.jpg');">
              </a>
              <div class="text float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_3.jpg');">
              </a>
              <div class="text float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_4.jpg');">
              </a>
              <div class="text float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_5.jpg');">
              </a>
              <div class="text float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
          ...
          <div class="col-md-6 col-lg-4 d-flex ftco-animate">
          	<div class="blog-entry">
              <a href="single.html" class="block-20" style="background-image: url('<?php echo url('/'); ?>/images/image_6.jpg');">
              </a>
              <div class="text float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(<?php echo url('/'); ?>/images/person_1.jpg)">
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(<?php echo url('/'); ?>/images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url(<?php echo url('/'); ?>/images/person_3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
